...
const MAINNET = {
    ethereum: {
        key: 'ethereum',
        id: 2,
        context: types_1.Context.ETH,
        contracts: {
            ...wormhole_sdk_1.CONTRACTS.MAINNET.ethereum,
    ...
    solana: {
        key: 'solana',
        id: 1,
        context: types_1.Context.SOLANA,
        contracts: {
            ...wormhole_sdk_1.CONTRACTS.MAINNET.solana,
    ...
    polygon: {
        ...
        context: types_1.Context.ETH,
        contracts: {
            ...wormhole_sdk_1.CONTRACTS.MAINNET.polygon,
            relayer: '0xcafd2f0a35a4459fa40c0517e17e6fa2939441ca',
    ...
    bsc: {
        ...
        context: types_1.Context.ETH,
        contracts: {
            ...wormhole_sdk_1.CONTRACTS.MAINNET.bsc,
            relayer: '0xcafd2f0a35a4459fa40c0517e17e6fa2939441ca',
        },
    ...
    avalanche: {
        ...
        context: types_1.Context.ETH,
        contracts: {
            ...wormhole_sdk_1.CONTRACTS.MAINNET.avalanche,
            relayer: '0xcafd2f0a35a4459fa40c0517e17e6fa2939441ca',
            cctpContracts: {
    ...
    fantom: {
        ...
        context: types_1.Context.ETH,
        contracts: {
            ...wormhole_sdk_1.CONTRACTS.MAINNET.fantom,
            relayer: '0xcafd2f0a35a4459fa40c0517e17e6fa2939441ca',
        },
        finalityThreshold: 1,
        nativeTokenDecimals: 18,
    ...
    celo: {
        ...
        context: types_1.Context.ETH,
        contracts: {
            ...wormhole_sdk_1.CONTRACTS.MAINNET.celo,
            relayer: '0xcafd2f0a35a4459fa40c0517e17e6fa2939441ca',
        },
        finalityThreshold: 1,
        nativeTokenDecimals: 18,
    ...
    moonbeam: {
        ...
        context: types_1.Context.ETH,
        contracts: {
            ...wormhole_sdk_1.CONTRACTS.MAINNET.moonbeam,
            relayer: '0xcafd2f0a35a4459fa40c0517e17e6fa2939441ca',
        },
        finalityThreshold: 1,
        nativeTokenDecimals: 18,
    ...
    sui: {
        key: 'sui',
        id: 21,
        context: types_1.Context.SUI,
        contracts: {
            ...wormhole_sdk_1.CONTRACTS.MAINNET.sui,
            relayer: '0x57f4e0ba41a7045e29d435bc66cc4175f381eb700e6ec16d4fdfe92e5a4dff9f',
            suiRelayerPackageId: '0x38035f4c1e1772d43a3535535ea5b29c1c3ab2c0026d4ad639969831bd1d174d',
            suiOriginalTokenBridgePackageId: '0x26efee2b51c911237888e5dc6702868abca3c7ac12c53f76ef8eba0697695e3d',
        },
        finalityThreshold: 0,
        nativeTokenDecimals: 9,
    },
    aptos: {
        key: 'aptos',
        id: 22,
        context: types_1.Context.APTOS,
        contracts: wormhole_sdk_1.CONTRACTS.MAINNET.aptos,
        finalityThreshold: 0,
    ...
    arbitrum: {
        ...
        context: types_1.Context.ETH,
        contracts: {
            ...wormhole_sdk_1.CONTRACTS.MAINNET.arbitrum,
            cctpContracts: {
    ...
    optimism: {
        ...
        context: types_1.Context.ETH,
        contracts: {
            ...wormhole_sdk_1.CONTRACTS.MAINNET.optimism,
            cctpContracts: {
    ...
    base: {
        ...
        context: types_1.Context.ETH,
        contracts: {
            ...wormhole_sdk_1.CONTRACTS.MAINNET.base,
    ...
    sei: {
        key: 'sei',
        id: 32,
        context: types_1.Context.SEI,
        contracts: {
            ...wormhole_sdk_1.CONTRACTS.MAINNET.sei,
            seiTokenTranslator: '',
        },
        finalityThreshold: 0,
    ...
    wormchain: {
        context: types_1.Context.COSMOS,
        key: 'wormchain',
        id: 3104,
        contracts: {
            ...
            ibcShimContract: 'wormhole14ejqjyq8um4p3xfqj74yld5waqljf88fz25yxnma0cngspxe3les00fpjx',
        },
        finalityThreshold: 0,
        nativeTokenDecimals: 6,
    },
...
exports.default = MAINNET_CONFIG;
