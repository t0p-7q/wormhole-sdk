...
function getTransferWrappedWithPayloadAccounts(tokenBridgeProgramId, wormholeProgramId, payer, message, from, fromOwner, tokenChain, tokenAddress, cpiProgramId) {
    ...
    const { wormholeBridge, wormholeMessage, wormholeEmitter, wormholeSequence, wormholeFeeCollector, clock, rent, systemProgram, } = (0, wormhole_1.getPostMessageCpiAccounts)(tokenBridgeProgramId, wormholeProgramId, payer, message);
    return {
...
//# sourceMappingURL=transferWrappedWithPayload.js.map