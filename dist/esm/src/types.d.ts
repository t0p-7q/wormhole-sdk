...
export type AnyContext = EthContext<WormholeContext> | SolanaContext<WormholeContext> | SuiContext<WormholeContext> | AptosContext<WormholeContext> | SeiContext<WormholeContext> | CosmosContext<WormholeContext>;
export type AnyContracts = EthContracts<WormholeContext> | SolContracts<WormholeContext> | SuiContracts<WormholeContext> | AptosContracts<WormholeContext> | SeiContracts<WormholeContext> | CosmosContracts<WormholeContext>;
