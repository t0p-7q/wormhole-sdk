...
import { TokenId, ChainName, ChainId, ParsedRelayerPayload, NATIVE } from '../../types';
 ...
 * }
 */
export declare abstract class RelayerAbstract<TransactionResult> extends TokenBridgeAbstract<TransactionResult> {
    /**
     ...
     */
    protected relaySupported(chain: ChainName | ChainId): boolean;
    /**
     ...
     */
    protected abstract sendWithRelay(token: TokenId | 'native', amount: string, toNativeToken: string, sendingChain: ChainName | ChainId, senderAddress: string, recipientChain: ChainName | ChainId, recipientAddress: string, overrides?: any): Promise<TransactionResult>;
    protected abstract estimateSendWithRelayGas(token: TokenId | typeof NATIVE, amount: string, sendingChain: ChainName | ChainId, senderAddress: string, recipientChain: ChainName | ChainId, recipientAddress: string, relayerFee: any, toNativeToken: string): Promise<BigNumber>;
    /**
     ...
     */
    protected abstract calculateNativeTokenAmt(destChain: ChainName | ChainId, tokenId: TokenId, amount: BigNumberish, walletAddress: string): Promise<BigNumber>;
    /**
     ...
     */
    protected abstract calculateMaxSwapAmount(destChain: ChainName | ChainId, tokenId: TokenId, walletAddress: string): Promise<BigNumber>;
    /**
     ...
     */
    protected abstract getRelayerFee(sourceChain: ChainName | ChainId, destChain: ChainName | ChainId, tokenId: TokenId): Promise<BigNumber>;
